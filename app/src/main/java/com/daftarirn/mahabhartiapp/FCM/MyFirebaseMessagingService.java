package com.daftarirn.mahabhartiapp.FCM;
...
import com.daftarirn.mahabhartiapp.MainActivity;
import com.daftarirn.mahabhartiapp.R;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageTitle, String messageBody, String link) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setLargeIcon(BitmapFactory.decodeResource(getBaseContext().getResources(), R.mipmap.mahabharti))
                .setSmallIcon(R.mipmap.mahabharti)
